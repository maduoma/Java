...
class ArrayListDemo {
    public static void main(String[] args) {
        ...
        for(Object o : list1){
            System.out.println(o.toString()); // List1 returned object since since the array is not explicitly type and
                                              // must be converted to String before printing
        }
        System.out.println("----------Get me the element at position zero----------------");
        String s = (String) list1.get(0); //List1 returned object since since the array is not explicitly type and must be converted to String before printing
